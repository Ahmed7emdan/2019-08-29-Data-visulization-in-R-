...
carpentry: "SW"    # what kind of Carpentry ("swc").  
                      # Be sure to update the Carpentry type in _config.yml as well.  
venue: "Online"        # brief name of host site without address (e.g., " Online")
address: "Online"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "Luxembourg"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
...
humandate: "August 28-129, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: Feb 17-18, 202250     # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: Feb 17-18, 202250        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Carpentrz instructor"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
